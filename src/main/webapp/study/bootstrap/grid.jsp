...
<body>
	<div class="container-fluid">
		...
		<div class="row">
			<div class="col-xs-6 col-sm-3 col-md-6 bbox"><img alt="One" 	src="http://www.placehold.it/100x100?text=One"></div>
			<div class="col-xs-6 col-sm-3 col-md-2 bbox"><img alt="Two" 	src="http://www.placehold.it/100x100?text=Two"></div>
			<div class="col-xs-6 col-sm-3 col-md-2 bbox"><img alt="Three" 	src="http://www.placehold.it/100x100?text=Three"></div>
			<div class="col-xs-6 col-sm-3 col-md-2 bbox"><img alt="Four" 	src="http://www.placehold.it/100x100?text=Four"></div>
		</div>
